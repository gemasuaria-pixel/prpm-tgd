    ...
    <div class=" p-5">
        ...
        <div class="card border-0 rounded-4 p-5 mb-4">
            ...
            <div style="{{ $step !== 1 ? 'display:none;' : '' }}">
                @include('livewire.pengabdian.laporan.steps.informasi-umum')
            </div>

            {{-- Step 2 --}}
            <div style="{{ $step !== 2 ? 'display:none;' : '' }}">
                @include('livewire.pengabdian.laporan.steps.informasi-laporan')
            </div>

            {{-- Step 3 --}}
            <div style="{{ $step !== 3 ? 'display:none;' : '' }}">
                @include('livewire.pengabdian.laporan.steps.dokumen')
            </div>

            {{-- Step 4 --}}
            <div style="{{ $step !== 4 ? 'display:none;' : '' }}">
                @include('livewire.pengabdian.laporan.steps.preview')
            </div>
        </div>
