<div class="container">
    ...
    <div class="mb-4">
        ...
        <table class="table table-bordered small">
            ...
            <tr>
                ...
                <td>{{ $identitas['bidang_pengabdian'] ?: '-' }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="mb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h6 class="fw-semibold text-muted mb-2">Mahasiswa</h6>
                @forelse($anggota_mahasiswa as $mhs)
                    <div class="border rounded-3 p-2 mb-2">
                        <strong>{{ $mhs['nama'] ?? '-' }}</strong><br>
                        <small>NIM: {{ $mhs['nim'] ?? '-' }}</small>
                    </div>
                @empty
                    <p class="text-muted small fst-italic">Tidak ada mahasiswa ditambahkan.</p>
                @endforelse
            </div>
        </div>
    </div>
    ...
    {{-- Mitra --}}
    <div class="mb-4">
        <h5 class="text-secondary mb-3"><i class="bi bi-building me-2"></i>Mitra</h5>
        <table class="table table-bordered small">
            <tr>
                <th>Nama Mitra</th>
            ...
            <tr>
                <th>Pernyataan Kebutuhan</th>
                <td>{{ $mitra['pernyataan_kebutuhan'] ?: '-' }}</td>
            </tr>
        </table>
    </div>
