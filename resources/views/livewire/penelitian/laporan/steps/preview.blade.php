<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-5">
        ...
        {{-- 📄 Informasi Umum --}}
        <div class="mb-4">
            <h6 class="fw-bold border-bottom pb-2 mb-3 text-uppercase text-secondary">Informasi Proposal</h6>
            <div class="row">
            ...
            <div class="mb-4">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Abstrak</dt>
                    <dd class="col-sm-8">{{ $laporan['abstrak'] ?: '-' }}</dd>

                    <dt class="col-sm-4">Metode Penelitian</dt>
                    <dd class="col-sm-8">{{ $laporan['metode_penelitian'] ?: '-' }}</dd>
