<div>
    ...
    <ul class="nav nav-tabs mt-3 px-3">
        <li class="nav-item">
            <a href="{{ route('reviewer.review.penelitian.proposal.index') }}" wire:navigate
                class="nav-link {{ request()->routeIs('reviewer.review.penelitian.proposal.index') ? 'active' : '' }}">
                Proposal
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('reviewer.review.penelitian.laporan.index') }}" wire:navigate
                        ...
                        @forelse ($laporans as $index => $review)
                            ...
                            <tr wire:key="review-{{ $review->id }}">
                                ...
                                <td class="text-center">
                                    <a wire:navigate
                                        href="{{ route('reviewer.review.penelitian.laporan.form', ['laporanId' => $review->reviewable_id]) }}"
