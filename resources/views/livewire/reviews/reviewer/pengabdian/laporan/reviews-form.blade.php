<div class="card border-0 shadow rounded-4">
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="fw-bold text-primary mb-0">{{ $laporan->proposalPengabdian->judul ?? '-' }}</h5>
        ...
        {{-- =============== ANGGOTA PENGABDIAN =============== --}}
        @if ($laporan->proposalPengabdian->anggota->isNotEmpty())
            <div class="mb-4">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered align-middle">
                        ...
                        <tbody>
                            @foreach ($laporan->proposalPengabdian->anggota as $a)
        ...
        <div class="mt-4">
            <h5 class="fw-semibold text-success mb-3">
                <i class="bi bi-pencil-square me-2"></i>Form Review Laporan Pengabdian
            </h5>
            ...
            <form wire:submit.prevent="simpanReview" class="needs-validation" novalidate>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a wire:navigate href="{{ route('reviewer.review.pengabdian.laporan.index') }}"
