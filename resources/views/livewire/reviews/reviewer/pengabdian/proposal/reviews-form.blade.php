    ...
    <div class="card-body p-4">
        ...
        <div class="row g-3 mb-3 small">
            <div class="col-md-6">
                ...
                <p><strong>Bidang:</strong> {{ $proposal->bidang_pengabdian ?? '-' }}</p>
            </div>
            <div class="col-md-6">
                    ...
                    <table class="table table-sm table-bordered align-middle">
                        ...
                        <tbody>
                            @foreach ($proposal->anggota as $a)
                              @if ($a instanceof \App\Models\User)
                                <tr>
        ...
        <div class="mt-4">
            <h5 class="fw-semibold text-success mb-3">
                <i class="bi bi-pencil-square me-2"></i>Form Review Proposal
            </h5>
            ...
            <form wire:submit.prevent="simpanReview" class="needs-validation" novalidate>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a wire:navigate href="{{ route('reviewer.review.pengabdian.proposal.index') }}"
