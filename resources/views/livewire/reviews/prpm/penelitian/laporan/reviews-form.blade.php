        ...
        <div class="mt-4">
            ...
            <form wire:submit.prevent="updateStatus" class="needs-validation" novalidate>
                <div class="row g-3">
                    ...
                    {{-- REVIEWER PICKER (MUNCUL HANYA JIKA "KIRIM KE REVIEWER") --}}
                    <div class="col-md-6"
                        x-data="reviewerPicker($el.dataset.reviewers, @entangle('reviewer_id'))"
                        x-init="init()"
                        data-reviewers='@json($reviewers)'
                        x-show="$wire.status === 'menunggu_validasi_reviewer'"
                        x-transition>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a wire:navigate href="{{ route('ketua-prpm.review.penelitian.laporan.index') }}"
