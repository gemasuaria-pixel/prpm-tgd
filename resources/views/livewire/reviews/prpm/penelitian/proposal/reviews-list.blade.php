            ...
            @forelse ($proposals as $index => $entry)
                <tr wire:key="proposal-{{ $entry->id }}">
                    ...
                    <td class="text-center">
                        <a wire:navigate
                            href="{{ route('ketua-prpm.review.penelitian.proposal.form', ['proposalId' => $entry->id]) }}"
