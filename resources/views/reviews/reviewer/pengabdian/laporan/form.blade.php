    ...
    <div class="container mt-4">
        ...
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body">
                ...
                {{-- ================== RINGKASAN ================== --}}
                <div class="mb-4">
                    <strong>Ringkasan Hasil Pengabdian:</strong>
                    <div class="border rounded p-3 bg-light mt-1">
                        {{ $laporan->ringkasan_laporan ?? (optional($proposal->infoPengabdian)->abstrak ?? 'Belum ada ringkasan hasil.') }}
                    </div>
                </div>
                ...
                @if (!empty($externalLinks))
                    <div class="mb-4">
                        <strong>Link Luaran Pengabdian:</strong>
