                        ...
                        <ul class="nav nav-tabs mt-3 px-3" id="reviewTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('ketua-prpm.review.proposal.index') }}"
                                    class="nav-link {{ request()->routeIs('review.proposal.index') ? 'active' : '' }}">
                                    Proposal Penelitian
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('ketua-prpm.review.laporan.index') }}"
                                    class="nav-link {{ request()->routeIs('review.laporan.index') ? 'active' : '' }}">
                                    Laporan Penelitian
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    @forelse ($laporans as $laporan)
                                        ...
                                        @endphp
                                        <tr>
                                        <tr data-bs-toggle="collapse" data-bs-target="#detail-laporan-{{ $laporan->id }}"
                                            aria-expanded="false" aria-controls="detail-laporan-{{ $laporan->id }}"
                                        ...
                                        <div class="modal fade" id="modalLaporan{{ $laporan->id }}" tabindex="-1"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                                <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                                                    ...
                                                    <div class="modal-body bg-light">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="p-3 bg-white rounded-3 shadow-sm h-100">
                                                                    ...
                                                                    <p><strong>Tahun Pelaksanaan:</strong>
                                                                        {{ $laporan->proposal->tahun_pelaksanaan ?? '-' }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="card border-0 shadow-sm mb-4">
                                                            <div class="card-body">
                                                                <h6 class="fw-semibold text-primary mb-2">Dokumen Laporan
                                                                </h6>
                                                        ...
                                                        @if ($laporan->reviews->isNotEmpty())
                                                            <div class="card border-0 shadow-sm mb-4">
                                                                <div class="card-body">
                                                                    <h6 class="fw-semibold text-primary mb-2">Hasil Review
                                                                        Reviewer</h6>
                            ...
                            @else bg-warning @endif">
                                                                    ...
                                                                    @if ($semuaApproved && $laporan->status_prpm !== 'final')
                                                                        <div
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                method="POST">
                                                                                @csrf
                                                                                <input type="hidden" name="status_prpm"
                                                                                    value="final">
                                                                                <button type="submit"
                                                        ...
                                                        <div class="card border-0 shadow-sm">
                                                            <div class="card-body">
                                                                <h6 class="fw-semibold text-primary mb-3">Tinjau & Perbarui
                                                                    Status</h6>
                                                                <form
                                                                    action="{{ route('ketua-prpm.prpm.review.updateStatusLaporan', $laporan->id) }}"
                                                                    method="POST">
                                                                    ...
                                                                    <div class="row g-3">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <label class="form-label fw-semibold">Tugaskan
                                                                                Reviewer</label>
                                                                            ...
                                                                            <small class="text-muted">Tekan Ctrl/Cmd untuk
                                                                                memilih lebih dari
                                                                                satu.</small>
                                                                        </div>
                                        ...
                                        <tr class="collapse-row">
                                            <td colspan="4" class="p-0">
                                                <div id="detail-laporan-{{ $laporan->id }}" class="collapse">
                                                    <x-review-item-detail :item="$laporan" type="laporan"
                                                        :reviewers="$reviewers" />
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center py-4 text-muted">Belum ada laporan
                                                penelitian.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
