                                        ...
                                        <div class="modal-body bg-light p-4">
                                            ...
                                            <div class="card border-0 shadow-sm rounded-4">
                                                <div class="card-body">
                                                    ...
                                                    <form
                                                        action="{{ route('ketua-prpm.review.proposal.updateStatus', $proposal->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="status" class="form-select" required>
                                                                    ...
                                                                    <option value="approved_by_prpm"
                                                                        {{ $proposal->status == 'approved_by_prpm' ? 'selected' : '' }}>
                                                                        Setujui & Tugaskan Reviewer</option>
                                                                    <option value="rejected"
                                                                        {{ $proposal->status == 'rejected' ? 'selected' : '' }}>
                                                                        Tolak</option>
                                                                    <option value="revisi"
                                                                        {{ $proposal->status == 'revisi' ? 'selected' : '' }}>
                                                                        Minta Revisi</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <small class="text-muted">Tekan Ctrl/Cmd untuk memilih
                                                                    lebih dari satu.</small>
                                                            </div>

                                                            <div class="col-12">
                                                                <label class="form-label fw-semibold">Catatan PRPM</label>
                                                                <textarea name="komentar_prpm" class="form-control" rows="3"
                                                                    placeholder="Berikan catatan atau alasan (opsional)">{{ $proposal->komentar_prpm ?? '' }}</textarea>
                                                            </div>
                                                        </div>
