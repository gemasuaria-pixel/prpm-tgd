                                ...
                                @if ($proposal->reviews->isNotEmpty())
                                    <div class="card border-0 shadow-sm mb-4">
                                        <div class="card-body">
                                            ...
                                            @php
                                                $jumlahReviewer = $proposal->reviews->count();
                                                $jumlahApproved = $proposal->reviews->where('status', 'approved')->count();
                                                $semuaApproved = $jumlahReviewer > 0 && $jumlahApproved === $jumlahReviewer;
                                            @endphp

                                            @if ($semuaApproved && $proposal->status_prpm !== 'final')
