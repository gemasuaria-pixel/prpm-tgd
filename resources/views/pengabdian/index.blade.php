...
@section('content')
    <!--begin::App Main-->
    <main class="app-main">
        <x-breadcrumbs>Status Pengabdian</x-breadcrumbs>
        <!--begin::App Content-->
                ...
                <div>
                    ...
                    <div class="row my-4">
                        <div class="col-md-6 d-grid ">
                            @if ($isProfileComplete)
                                <a href="{{ route('dosen.pengabdian.proposal.create') }}"
                                    class="btn btn-outline-primary btn-lg rounded-3 fw-semibold shadow-sm">
                                    <i class="bi bi-plus-circle me-2"></i> Usulan Pengabdian
                                </a>
                            @else
                        ...
                        <div class="col-md-6 d-grid">
                            @if ($proposalFinals->isNotEmpty())
                                ...
                                <button type="button"
                                    ...
                                    <i class="bi bi-file-earmark-text me-2"></i> Laporan Pengabdian
                                </button>
                            @else
                            ...
                            <div class="modal-content border-0 shadow-lg">
                                ...
                                <div class="modal-header bg-light border-bottom">
                                    <h5 class="modal-title fw-semibold" id="pilihProposalLabel">
                                        ...
                                        Pilih Proposal untuk Upload Laporan Pengabdian
                                    </h5>
                                    ...
                                    @forelse ($proposalFinals as $proposal)
                                        @php
                                            ...
                                            $identifier =
                                                ...
                                                now()->year .
                                                '-' .
                                                strtoupper(substr($proposal->jenis ?? 'PPM', 0, 3)) .
                                                '-' .
                                        ...
                                        <div
                                            ...
                                            <div class="flex-grow-1 me-3">
                                                ...
                                                <small class="text-muted d-block">
                                                    {{ ucfirst($proposal->jenis ?? 'Pengabdian') }} — Diterima
                                                    {{ $proposal->updated_at->translatedFormat('d F Y') }}
                                                </small>
                                                <small class="text-muted">ID: {{ $identifier }}</small>
                                            </div>

                                            <a href="{{ route('dosen.pengabdian.laporan.create', $proposal->id) }}"
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Status Pengabdian</h3>
                        </div>
