            ...
            <form action="{{ route('dosen.pengabdian.laporan.store', $proposal) }}" 
                ...
                <div class="form-section">
                    ...
                    <table class="table table-bordered table-hover mt-2">
                        ...
                        <tbody>
                            @foreach ($proposal->anggotaMahasiswa as $anggota)
                                <tr>
                                    <td>{{ $anggota->nama }}</td>
                                    <td>{{ $anggota->nim }}</td>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Tahun Pelaksanaan (jika berbeda)</label>
                        <input type="text" name="tahun_pelaksanaan" class="form-control"
                               value="{{ old('tahun_pelaksanaan', $proposal->tahun_pelaksanaan) }}">
                    </div>
                </div>
